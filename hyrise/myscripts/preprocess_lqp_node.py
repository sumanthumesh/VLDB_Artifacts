...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 3:
        ...
        output_path = f"{os.path.abspath(os.path.dirname(json_path))}/lqp_template.json"
    ...
    #Preprocess the file
    new_dict = preprocess_lqp_node(raw_dictionary)

    #Write dictionary to file
    with open("modified_lqp.json","w") as file:
