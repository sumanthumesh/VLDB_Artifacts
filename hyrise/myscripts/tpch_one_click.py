...
if __name__ == '__main__':
    ...
    commands.append(f"./isolate_hash {new_folder}/mem_blk_{pid}.txt {new_folder}/roitrace_{pid}.csv {new_folder}/isolate_{query_name}.trace")

    #Hotness from pintrace
    commands.append(f"./counter_trace_bridge {new_folder}/isolate_{query_name}.trace {new_folder}/trace_count.csv")
