...
namespace
{
const auto table_builder_test_types =
    boost::hana::tuple<int32_t, std::optional<float>, pmr_string>();
...
{
    auto table_builder = TableBuilder(ChunkOffset{4}, table_builder_test_types,
                                      table_builder_test_names);
