...
using SQLiteTestRunnerParam =
    std::tuple<std::pair<size_t /* line */, std::string /* sql */>,
               EncodingType>;
...
inline auto sqlite_testrunner_formatter =
    [](const ::testing::TestParamInfo<SQLiteTestRunnerParam> &info)
{
