...
TEST_F(UpdateNodeTest, HashingAndEqualityCheck)
{
    ...
    const auto other_update_node_a =
        UpdateNode::make("table_a", _mock_node, _mock_node);
    const auto other_update_node_b =
        UpdateNode::make("table_b", _mock_node, _mock_node);
    const auto other_update_node_c =
        UpdateNode::make("table_a", other_mock_node, _mock_node);
    const auto other_update_node_d =
        UpdateNode::make("table_a", _mock_node, other_mock_node);
    const auto other_update_node_e =
        UpdateNode::make("table_a", other_mock_node, other_mock_node);
