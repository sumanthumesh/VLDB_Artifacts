...
{
    // The CommitID specialization should treat MAX_COMMIT_ID like an unset
    // value.
...
// A concurrency stress test can be found at `stress_test.cpp`
// (AtomicMaxConcurrentUpdate).
