...
class MetaTableManagerMultiTablesTest
    : public MetaTableManagerTest,
      public ::testing::WithParamInterface<MetaTable>
{
};

auto meta_table_manager_test_formatter =
...
INSTANTIATE_TEST_SUITE_P(
    MetaTableManager, MetaTableManagerMultiTablesTest,
    ::testing::ValuesIn(MetaTableManagerTest::meta_tables()),
    meta_table_manager_test_formatter);
...
TEST_F(MetaTableManagerTest, ForwardsMethodCalls)
{
    ...
    mtm.update(mock_table->name(), mock_manipulation_values,
               mock_manipulation_values);
