...
TEST_F(TaskUtilsTest, VisitTasksStreamlineTasks)
{
    ...
    auto expected_tasks = std::vector<std::shared_ptr<AbstractTask>>{
        _task_d, _task_c, _task_b, _task_a};
...
TEST_F(TaskUtilsTest, VisitTasksDiamondStructure)
{
    ...
    auto expected_tasks = std::vector<std::shared_ptr<AbstractTask>>{
        _task_d, _task_b, _task_c, _task_a};
    auto actual_tasks = std::vector<std::shared_ptr<AbstractTask>>{};
...
TEST_F(TaskUtilsTest, VisitTasksNonConstTasks)
{
    ...
    auto expected_tasks =
        std::vector<std::shared_ptr<AbstractTask>>{_task_b, _task_a};
    auto actual_tasks = std::vector<std::shared_ptr<AbstractTask>>{};
...
TEST_F(TaskUtilsTest, VisitTasksConstTasks)
{
    ...
    auto expected_tasks =
        std::vector<std::shared_ptr<const AbstractTask>>{task_b, task_a};
