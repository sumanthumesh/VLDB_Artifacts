...
class EncodedStringSegmentTest : public BaseTestWithParam<SegmentEncodingSpec>
{
  protected:
    ...
    std::shared_ptr<ValueSegment<pmr_string>>
    _create_empty_string_value_segment()
    {
    ...
    std::shared_ptr<ValueSegment<pmr_string>>
    _create_empty_string_with_null_value_segment()
    {
        auto values = pmr_vector<pmr_string>(_row_count);
        ...
        return std::make_shared<ValueSegment<pmr_string>>(
    ...
    std::shared_ptr<ValueSegment<pmr_string>>
    _create_string_with_null_value_segment()
    {
        auto values = pmr_vector<pmr_string>(_row_count);
        auto null_values = pmr_vector<bool>(_row_count);
    ...
    std::shared_ptr<RowIDPosList> _create_sequential_position_filter()
    {
        ...
        for (auto offset_in_referenced_chunk = ChunkOffset{0};
             offset_in_referenced_chunk < _row_count;
...
TEST_P(EncodedStringSegmentTest, SequentiallyReadNotNullableEmptyStringSegment)
{
    ...
    resolve_encoded_segment_type<pmr_string>(
...
TEST_P(EncodedStringSegmentTest,
       SequentiallyReadNullableStringSegmentWithChunkOffsetsList)
{
    auto value_segment = _create_string_with_null_value_segment();
    auto abstract_encoded_segment =
        this->_encode_segment(value_segment, DataType::String);
...
TEST_P(EncodedStringSegmentTest,
       SequentiallyReadNullableStringSegmentWithShuffledChunkOffsetsList)
{
    auto value_segment = _create_string_with_null_value_segment();
    auto abstract_encoded_segment =
        this->_encode_segment(value_segment, DataType::String);
