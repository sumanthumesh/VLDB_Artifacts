...
TEST_F(TableColumnDefinitionTest, HashingAndEqualityCheck)
{
    ...
    TableColumnDefinition different_column_definition_a{"c", DataType::Int,
                                                        false};
    TableColumnDefinition different_column_definition_b{"a", DataType::Double,
                                                        false};
    TableColumnDefinition different_column_definition_c{"a", DataType::Int,
                                                        true};
