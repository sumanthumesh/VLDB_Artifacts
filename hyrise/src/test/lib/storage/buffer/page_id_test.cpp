...
TEST_F(PageIDTest, TestEqualityOperator)
{
    ...
    EXPECT_EQ(PageID(PageSizeType::KiB16, 29, true),
              PageID(PageSizeType::KiB16, 29, true));
    EXPECT_NE(PageID(PageSizeType::KiB16, 28, true),
              PageID(PageSizeType::KiB16, 29, true));
    EXPECT_NE(PageID(PageSizeType::KiB256, 28, true),
              PageID(PageSizeType::KiB16, 28, true));
}
