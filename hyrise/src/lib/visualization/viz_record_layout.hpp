...
/**
 * Utility for creating graphviz records
 * (http://www.graphviz.org/doc/info/shapes.html#record), which are basic
 * layouted nodes
 */
struct VizRecordLayout
{
    ...
    // backslash character" http://www.graphviz.org/doc/info/shapes.html#record
