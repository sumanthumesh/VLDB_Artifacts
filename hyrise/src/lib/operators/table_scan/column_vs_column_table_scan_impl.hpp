...
{
  public:
    ColumnVsColumnTableScanImpl(const std::shared_ptr<const Table> &in_table,
  ...
  private:
    ...
    _typed_scan_chunk_with_iterables(ChunkID chunk_id,
    ...
    std::shared_ptr<RowIDPosList> _typed_scan_chunk_with_iterators(
