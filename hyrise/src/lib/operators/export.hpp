 ...
 * For .csv files, a CSV config is added, which is located in the
 * <filename>.json file. Documentation of the file formats can be found in
 * BinaryWriter and CsvWriter header files.
 */
