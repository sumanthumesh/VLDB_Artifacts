...
/**
 * Reference implementation of all Join operations that Hyrise supports,
 * providing a "ground truth" to test the "real" join operators (JoinHash etc.).
...
class JoinVerification : public AbstractJoinOperator
{
  ...
  private:
    ...
    bool _evaluate_predicate(const OperatorJoinPredicate &predicate,
                             const Tuple &tuple_left,
