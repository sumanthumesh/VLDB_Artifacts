...
/**
 * The following structs describe the different window function traits. Given a
 * ColumnType and WindowFunction, certain traits, such as the resulting data
 * type, can be deduced.
 */
...
struct WindowFunctionTraits<
    ...
    typename std::enable_if_t<window_function == WindowFunction::Min ||
                                  window_function == WindowFunction::Max ||
...
struct WindowFunctionTraits<
    ColumnType, window_function,
    typename std::enable_if_t<window_function == WindowFunction::Avg &&
                                  std::is_arithmetic_v<ColumnType>,
                              void>>
{
...
struct WindowFunctionTraits<
    ColumnType, window_function,
    typename std::enable_if_t<window_function == WindowFunction::Sum &&
                                  std::is_integral_v<ColumnType>,
                              void>>
{
    typedef int64_t ReturnType;
    static constexpr DataType RESULT_TYPE = DataType::Long;
...
struct WindowFunctionTraits<
    ColumnType, window_function,
    typename std::enable_if_t<window_function == WindowFunction::Sum &&
                                  std::is_floating_point_v<ColumnType>,
                              void>>
{
    typedef double ReturnType;
    static constexpr DataType RESULT_TYPE = DataType::Double;
...
struct WindowFunctionTraits<
    ColumnType, window_function,
    typename std::enable_if_t<window_function ==
...
struct WindowFunctionTraits<
    ...
    typename std::enable_if_t<!std::is_arithmetic_v<ColumnType> &&
                                  (window_function == WindowFunction::Avg ||
                                   window_function == WindowFunction::Sum ||
                                   window_function ==
                                       WindowFunction::StandardDeviationSample),
                              void>>
{
