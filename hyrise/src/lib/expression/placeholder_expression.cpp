...
std::string
PlaceholderExpression::description(const DescriptionMode /*mode*/) const
{
...
bool PlaceholderExpression::_shallow_equals(
    const AbstractExpression &expression) const
{
    ...
    const auto &parameter_expression_rhs =
        static_cast<const PlaceholderExpression &>(expression);
...
bool PlaceholderExpression::_on_is_nullable_on_lqp(
