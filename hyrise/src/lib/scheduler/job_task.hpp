...
/**
 * A general purpose Task for any kind of work (i.e. anything that fits into a
 * void()-function) that can be parallelized.
 *
 * Usage example:
 *
 *
...
{
  public:
    explicit JobTask(const std::function<void()> &fn,
