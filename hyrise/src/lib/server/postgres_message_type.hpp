...
// Each message contains a field (4 bytes) indicating the packet's size
// including itself. Using extra variable here to avoid magic numbers.
...
enum class PostgresMessageType : unsigned char
{
    ...
    // Selection of error and notice message fields. All possible fields are
    // documented at:
