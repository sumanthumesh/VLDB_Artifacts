...
class PluginManager : public Noncopyable
{
  ...
  public:
    ...
    void exec_user_function(const PluginName &plugin_name,
                            const PluginFunctionName &function_name);
    void
    exec_pre_benchmark_hook(const PluginName &plugin_name,
  ...
  protected:
    ...
    // This method is called during destruction and stops and unloads all
    // currently loaded plugions.
    void _clean_up();
