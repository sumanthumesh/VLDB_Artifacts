...
// We have to instantiate this function here because clang-12(+) does not
// instantiate it and llvm-cov throws a warning (functions have mismatched
// data). See
...
AbstractPlugin::provided_user_executable_functions()
{
    return {};
}
