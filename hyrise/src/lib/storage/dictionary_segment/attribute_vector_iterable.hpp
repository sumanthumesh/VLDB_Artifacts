...
class AttributeVectorIterable
    : public PointAccessibleSegmentIterable<AttributeVectorIterable>
{
  public:
    ...
    explicit AttributeVectorIterable(const BaseDictionarySegment &segment,
        ...
        : _attribute_vector{*segment.attribute_vector()},
          _null_value_id{null_value_id}, _access_counter(segment.access_counter)
    {
    }
    ...
    void _on_with_iterators(const Functor &functor) const
    {
        resolve_compressed_vector_type(
            ...
            [&](const auto &vector)
            {
                ...
                auto begin = Iterator<CompressedVectorIterator>{
                    _null_value_id, vector.cbegin(), ChunkOffset{0u}};
                auto end = Iterator<CompressedVectorIterator>{
                    _null_value_id, vector.cend(),
                    static_cast<ChunkOffset>(_attribute_vector.size())};
                functor(begin, end);
            });

        _access_counter[SegmentAccessCounter::AccessType::Sequential] +=
                            ...
                            const Functor &functor) const
    {
        resolve_compressed_vector_type(
            ...
            [&](const auto &vector)
            {
                ...
                auto begin =
                    PointAccessIterator<Decompressor, PosListIteratorType>{
                        _null_value_id, vector.create_decompressor(),
        ...
        _access_counter[SegmentAccessCounter::access_type(*position_filter)] +=
  ...
  private:
    ...
    class Iterator
        : public AbstractSegmentIterator<Iterator<CompressedVectorIterator>,
                                         SegmentPosition<ValueID>>
    {
      public:
        using ValueType = ValueID;

        explicit Iterator(const ValueID null_value_id,
              ...
              SegmentPosition<ValueID>, PosListIteratorType>
    {
      public:
        ...
        PointAccessIterator(const ValueID null_value_id,
      ...
      private:
        ...
        SegmentPosition<ValueID> dereference() const
        {
            ...
            const auto value_id =
                static_cast<ValueID>(_attribute_decompressor.get(
