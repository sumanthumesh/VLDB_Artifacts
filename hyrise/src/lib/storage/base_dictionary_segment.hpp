...
class BaseDictionarySegment : public AbstractEncodedSegment
{
  public:
    ...
    /**
     * @brief Returns index (i.e. ValueID) of first dictionary entry >= search
     * value
     *
     ...
     *
     * @param value the search value
     * @return INVALID_VALUE_ID if all entries are smaller than or equal to
     * value
     */
    ...
    virtual std::shared_ptr<const BaseCompressedVector>
    attribute_vector() const = 0;
