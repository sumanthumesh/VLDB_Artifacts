...
// ReferenceSegment is a specific segment type that stores all its values as
// position list of a referenced segment
class ReferenceSegment : public AbstractSegment
{
  ...
  protected:
    // After an operator finishes, its shared_ptr reference to the table gets
    // deleted. Thus, the ReferenceSegments need their own shared_ptrs
