...
/**
 * Forward iterator that iterates over a tsl::sparse_map that maps a DataType to
 * a vector of RowIDs. The iteration process is as if the map would have been
 * flattened and then iterated.
 *
