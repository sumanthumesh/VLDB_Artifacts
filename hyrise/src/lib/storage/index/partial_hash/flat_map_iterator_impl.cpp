...
FlatMapIteratorImpl<DataType>::FlatMapIteratorImpl(MapIterator it)
...
template <typename DataType>
bool FlatMapIteratorImpl<DataType>::operator==(
    const BaseFlatMapIteratorImpl &other) const
{
...
template <typename DataType>
std::unique_ptr<BaseFlatMapIteratorImpl>
FlatMapIteratorImpl<DataType>::clone() const
{
