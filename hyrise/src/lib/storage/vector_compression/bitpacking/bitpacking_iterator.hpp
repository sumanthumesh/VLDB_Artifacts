...
class BitPackingIterator
    : public BaseCompressedVectorIterator<BitPackingIterator>
{
  public:
    explicit BitPackingIterator(const pmr_compact_vector &data,
                                const size_t absolute_index = 0u)
    ...
    BitPackingIterator &operator=(const BitPackingIterator &other)
    {
        ...
        DebugAssert(&_data == &other._data,
                    "Cannot reassign BitPackingIterator");
