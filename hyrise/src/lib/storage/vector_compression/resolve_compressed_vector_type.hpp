 ...
 *        specific implementation of a compressed vector (such as
 * BitPackingVector).
 *
 *
 * Example
...
void resolve_compressed_vector_type(const BaseCompressedVector &vector,
                                    const Functor &functor)
{
    hana::fold(
        compressed_vector_for_type, false,
