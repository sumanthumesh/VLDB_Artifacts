...
template <typename T> class FixedWidthIntegerVector;
...
constexpr auto compressed_vector_for_type = hana::make_map(
    hana::make_pair(enum_c<CompressedVectorType,
                           CompressedVectorType::FixedWidthInteger4Byte>,
                    hana::type_c<FixedWidthIntegerVector<uint32_t>>),
    hana::make_pair(enum_c<CompressedVectorType,
                           CompressedVectorType::FixedWidthInteger2Byte>,
    ...
    hana::make_pair(
        enum_c<CompressedVectorType, CompressedVectorType::BitPacking>,
...
CompressedVectorType get_compressed_vector_type()
{
    ...
    hana::fold(compressed_vector_for_type, false,
               [&](auto match_found, auto pair)
               {
                   if (!match_found &&
                       (hana::second(pair) == hana::type_c<CompressedVectorT>))
                   {
    ...
    Assert(compression_type,
           "CompressedVectorType not added to compressed_vector_for_type");
