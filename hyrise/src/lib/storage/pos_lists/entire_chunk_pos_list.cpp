...
size_t EntireChunkPosList::memory_usage(
    const MemoryUsageCalculationMode /*mode*/) const
{
    return sizeof *this;
}

AbstractPosList::PosListIterator<EntireChunkPosList, RowID>
EntireChunkPosList::begin() const
{
    return {this, ChunkOffset{0}};
}

AbstractPosList::PosListIterator<EntireChunkPosList, RowID>
EntireChunkPosList::end() const
{
    return {this, static_cast<ChunkOffset>(size())};
}

AbstractPosList::PosListIterator<EntireChunkPosList, RowID>
EntireChunkPosList::cbegin() const
{
    return begin();
}

AbstractPosList::PosListIterator<EntireChunkPosList, RowID>
EntireChunkPosList::cend() const
{
    return end();
}
