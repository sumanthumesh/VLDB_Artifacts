...
JCCHTableGenerator::JCCHTableGenerator(
    ...
    : JCCHTableGenerator(dbgen_path, data_path, scale_factor,
...
JCCHTableGenerator::generate()
{
    ...
    generate_csv_tables_with_external_dbgen(_dbgen_path, table_names,
                                            "resources/benchmark/jcch", _path,
                                            _scale_factor, "-k");
