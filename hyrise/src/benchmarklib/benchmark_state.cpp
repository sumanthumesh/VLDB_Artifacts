...
BenchmarkState::BenchmarkState(const Duration init_max_duration)
...
{
    Assert(state != State::Running && other.state != State::Running,
           "Cannot assign to or from a running benchmark");
